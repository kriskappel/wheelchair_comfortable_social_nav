...
def bringup_sim(index, folder_name, sim_launch_path, nav_launch_path, pose_goal):
	...
	bag_args = "record -O " + bags_folder + "/" + folder_name + str(index) + ".bag -a"
...
if __name__ == '__main__':
	...
	try:
		for i in range(0, num_runs):
			bringup_sim(i, bag_folder_name, sim_launch_path, nav_launch_path, pose_goal)
